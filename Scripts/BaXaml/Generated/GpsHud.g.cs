    ...
    public static class GpsHudDocument
    {
        ...
        public static BaUiBuiltPanel Build()
        {
            ...
            return Fluent.BaUi.Overlay("BaXaml_GpsHud", sortOrder: 9000)
                ...
                .Panel(BaPanelRecipe.ActionPanel, BaUiLayout.PanelWidth, metrics.PanelHeight)
                .Header(h => h
                    .TitleLeft(BaUiText.Loc("voogle_route_panel_title", "VOOGLE ROUTE"))
                    .Icon(BaIcons.Settings, null, "⚙"))
                .Body(b => b
